...
Ready to contribute? Here's how to set up `label-free` for local development.

1. Fork the `label-free` repo on GitHub.

2. Clone your fork locally:

    ```bash
    git clone git@github.com:{your_name_here}/label-free.git
    ```
